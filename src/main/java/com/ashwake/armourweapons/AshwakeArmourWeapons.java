...
public class AshwakeArmourWeapons {
    ...
    // Creates a new food item with the id "ashwake_armour_weapons:ashwake_item", nutrition 1 and saturation 2
    ...
    // Creates a creative tab with the id "ashwake_armour_weapons:ashwake_tab" for the mod item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ASHWAKE_TAB = CREATIVE_MODE_TABS.register("ashwake_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                output.accept(ASHWAKE_ITEM.get()); // Add the item to the tab. For your own tabs, this method is preferred over the event
            }).build());
